...
namespace PortalEscolar.Infrastructure.Migrations
{
    ...
    [Migration("20220929124307_AdicionadoAColunaTurmaNaTabelaAluno")]
    partial class AdicionadoAColunaTurmaNaTabelaAluno
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalEscolar.Domain.Entities.Diretoria.Diretor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            DataNascimento = new DateTime(2002, 9, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            DataRegistro = new DateTime(2022, 9, 29, 12, 43, 6, 462, DateTimeKind.Utc).AddTicks(9471),
            ...
            modelBuilder.Entity("PortalEscolar.Domain.Entities.SalaAula.AlunoContext.Aluno", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PortalEscolar.Domain.Entities.SalaAula.ProfessoraContext.Professora", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PortalEscolar.Domain.Entities.Diretoria.Matricula.Matricula", b =>
                {
                    b.HasOne("PortalEscolar.Domain.Entities.SalaAula.AlunoContext.Aluno", "Aluno")
                        .WithMany("Matricula")
            ...
            modelBuilder.Entity("PortalEscolar.Domain.Entities.SalaAula.Turma", b =>
                {
                    b.HasOne("PortalEscolar.Domain.Entities.SalaAula.ProfessoraContext.Professora", "Professora")
                        .WithMany("Turma")
